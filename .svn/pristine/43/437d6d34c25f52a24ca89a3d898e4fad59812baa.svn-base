...
public class Board extends Observable {
    ...
    /**
     * The TetrisGUI called this method, set the custom width 
     * for the Board.
     * @param theWidth new Width of the Board.
     */
    ...
    /**
     * The TetrisGUI called this method, set the custom height 
     * for the Board.
     * @param theHeight new Height of the Board.
     */
